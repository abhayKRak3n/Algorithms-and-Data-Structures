...
public class CompetitionDijkstra {
	...
	private void initialise() {
		...
		try {
			...
			for (int i = 0; i < S; i++) {
				if (input.hasNext()) {
					int intersection1 = input.nextInt();
					int intersection2 = input.nextInt();
